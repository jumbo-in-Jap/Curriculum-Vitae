...
内定者時代から[Yahooの人間として登壇](https://techblog.yahoo.co.jp/ios/yxcm/)の機会をもらい入社前から色々活動する。入社後はインフラエンジニアを経験し、複雑なマニュアル作業をFabric(Python)で手順を自動化（コード化）。アプリエンジニアとしてはベトナムのラボ開発を支援しながら機能開発を担当。AppleTVアプリ開発PJでPMを担当、リリース後ストアでもフューチャーされ長い間1位を獲得。
